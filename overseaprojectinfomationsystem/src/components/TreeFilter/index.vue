  ...
  <div class="card filter">
    ...
    <el-scrollbar :style="{ height: title ? `calc(100% - 95px)` : `calc(100% - 56px)` }">
      <el-tree ref="treeRef" default-expand-all :node-key="id" :data="multiple ? treeData : treeAllData"
        ...
        :highlight-current="!multiple" :expand-on-click-node="false" :check-on-click-node="multiple" :props="defaultProps"
...
interface TreeFilterProps {
  requestApi?: (data?: any) => Promise<any> | any; // 请求分类数据的 api ==> 非必传
