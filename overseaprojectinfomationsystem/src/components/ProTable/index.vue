...
<template>
  ...
  <div class="card table-main">
    ...
    <!-- 表格主体 -->
    <el-table class="cell" ref="tableRef" v-bind="$attrs" :data="processTableData" :border="border" :row-key="rowKey"
      @selection-change="selectionChange" :header-cell-style="{ fontSize: '22px', height: '60px' }"
      :cell-style="{ color: '#000', fontSize: '22px', height: '40px' }" :row-style="{ height: '60px' }"
...
const processTableData = computed(() => {
  ...
  // console.log("propsrequestAuto", JSON.parse(JSON.stringify(props.requestAuto)))
