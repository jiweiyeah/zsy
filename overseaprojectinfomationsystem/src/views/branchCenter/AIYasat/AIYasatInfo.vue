<template>
  <div class="card table-main">
    <p style="margin: 10px; margin-top: 0; font-size: 25px; text-align: center">AI Yasat技术支持中心简介</p>
    <span style="font-size: 22px; line-height: 34px">
      ...
      %。现有员工近2400名，其中工程技术人员1900多名，拥有66名博士、610名硕士、近100余名行业有影响力专家组成的核心科技团队和一大批经验丰富的处理解释工程师。与国内浙江大学、中国科学技术大学、中国石油大学（北京）、中国石油大学（华东）、西北大学和美国科罗拉多矿业学院、加拿大卡尔加里大学等国内外近20所知名院校和研究机构有着广泛的技术交流与合作，与中国石油大学（北京）、中国石油大学（华东）、浙江大学地球科学系等10余所大学院系建立研究联合培养基地和协同创新中心。
    ...
    <el-row :gutter="12" style="margin-top: 20px">
      ...
      <el-col :span="8"><span style="font-size: 20px">AI Yasat技术支持中心</span></el-col>
      <el-col :span="4">
